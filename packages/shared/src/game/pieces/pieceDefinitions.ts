...
export const CHECKER: PieceType = {
  id: 'checker',
  name: 'Checker',
  tier: 'pawn',
  cost: 11,
  victoryPoints: 11,
  symbol: '◉',
  description: 'Moves diagonally forward 1 square. Captures by jumping diagonally forward over an enemy. Promotes to Checker King.',
  isRoyal: false,
  isMandatory: false,
  canCastle: false,
  canBeCaptured: true,
...
export const CHECKER_KING: PieceType = {
  id: 'checker-king',
  name: 'Checker King',
  tier: 'piece',
  cost: 35,
  victoryPoints: 35,
  symbol: '◎',
  description: 'Promoted Checker piece. Moves diagonally 1 square any direction. Captures by jumping diagonally over enemies.',
  isRoyal: false,
  isMandatory: false,
  promotionOnly: true, // Can only be obtained by promoting a Checker piece
  canCastle: false,
  canBeCaptured: true,
  canFreeze: false,
  canBeJumpedOver: true,
...
export const INQUISITOR: PieceType = {
  ...
  victoryPoints: 80,
  symbol: '⚖',
  description: 'Moves 1-2 squares diagonally. Cannot capture but freezes adjacent enemies.',
  isRoyal: false,
  isMandatory: false,
  canCastle: false,
  canBeCaptured: true,
  ...
  movement: {
    slides: [],
    leaps: [
      { dx: 1, dy: 1, symmetric: true }, // 1 square diagonal
      { dx: 2, dy: 2, symmetric: true }, // 2 squares diagonal
    ],
    special: [],
  },
  captureType: 'none', // Cannot capture - only freezes!
